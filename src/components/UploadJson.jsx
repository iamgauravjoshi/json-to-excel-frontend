  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-indigo-100">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-indigo-600">JSON to Excel Converter</h1>
        <p className="text-gray-600 mt-2">Upload your JSON file and download the Excel file instantly!</p>
      </div>
